...
export default async function Dashboard() {
  ...
  const blocks = [
    { title: "PROFIT",   value: "$34.5k",  sub: "Last 7 days",  delta: "+8.2%"  },
    { title: "REVENUE",  value: "$347k",   sub: "Month to date", delta: "+3.1%" },
    { title: "MEMBERS",  value: "207",     sub: "New signups",   delta: "+12%"  },
    { title: "Visitors", value: "19,845",  sub: "Last 24h",      delta: "+5.4%" },
  ];
